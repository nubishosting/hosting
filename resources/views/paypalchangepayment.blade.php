...
#text3d {
    ...
    <body id="loading"  style="background-image: url('{{ asset('images/prereg.png')}}'); 
        ...
        <div style="margin-right: 1rem;
                    margin-top:2rem;
                   ">
           <h1 id="text3D">PAY NOW</h1>
        
        </div>
        <form action="/paypalchangepayment" method="POST">
        @csrf
                <div class="instagram"style=" width:400px;margin-left:475px;
                    ...
                    <?php 
                           if(isset($_GET['plan'])) 
                           $plan = $_GET['plan'];
                           {echo "<input id='plan' type='text' 
                                class='input field' 
                                style='border:1px solid #556; width:200px;height:50px; border-radius: 10px; 
                                padding-left:4rem;
                                margin-top:0.5rem;
                  ...
                  <!-- <input  type="hidden" name="plan" value={{$plan}}/>    --> 
                    <button class="button instagram" type="submit" style="">
                    <span class="gradient"></span><strong>Pay</strong>
