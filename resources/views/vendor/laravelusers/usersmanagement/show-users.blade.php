                ...
                <div class="card" style="background-color:lemonchiffon;">
                    <div class="card-header"style="background-color:orange;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <a href="adminhome "><img src="/images/home.png" alt="" width="25%"></a>
                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th class="no-search no-sort">Plan</th>
                                        <th class="no-search no-sort">Domain name</th>
                                        <th class="no-search no-sort">Database name</th>
