    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card" style="margin-top:5rem;">
                <div class="card-header" style="background-color:#e52f62; border-color:#e52f62;"><center><strong>{{ __('MANAGE YOUR SERVICE') }}</strong></center></div>
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                           <div class="col-md-3" style="padding-left:3rem;">
 	                            <img src="images/db.svg" alt="" style="width:70%;">                          
                            </div>

			                <div class="col-md-3" style="padding-left:3rem;">
		                        <img src="images/monitoring.png" alt="" style="width:80%;">    
			                </div>

  			                <div class="col-md-3" style="padding-left:1.5rem;">
                                <img src="images/usermanager.png" alt="" style="width:70%;">   
                            </div>	

                            <div class="col-md-3" style="padding-left:1.5rem;">
                                <img src="images/filemng.png" alt="" style="width:70%;">   
                            </div>	
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3" style="padding-left:0.5rem;">
                             <a href="prequel"> Manage database with Prequel</a>  

                              
                            </div>
 <div class="col-md-3" style="padding-left:2rem;">
     <a href="telescope"> Monitor activity with Telescope</a>                          
  </div>
 <div class="col-md-3" style="padding-left:2rem;">
