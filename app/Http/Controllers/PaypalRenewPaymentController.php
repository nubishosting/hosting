...
class PaypalRenewPaymentController extends Controller
{
    public function index(){
        $plan = request('plan');
        return view ('paypalrenewpayment');
    }
    ...
    {  
        try
        {
                ...
                $redirectUrls->setReturnUrl(URL::to('/paypalrenewpayment/status'),'?success=true')
                    ->setCancelUrl(URL::to('/paypalrenewpayment/status'),'?success=false');
        ...
        try
        {
            ...
            /* if ($dataArray['success'] == 'true'){ 
                ...
                if (empty($dataArray['PayerID'] ) || empty($dataArray['token'])) {
                    ...
                    return Redirect::to('/paypalrenewpayment/failure');
                }
                ...
                if ($result->getState() == 'approved') {
                    ...
                    return Redirect::to('/paypalrenewpayment/success');
                }    
